...
public class DriverForPromotionData {
	...
	public static void main(String[] args) {
		...
		PromotionPO model1 = new PromotionPO("00000","关爱程序员营销活动", PromotionType.Discount);
		model1.setRoomNumberPromotion(3, 0.7, 0, 0);
		System.out.println(driver.testAddPromotion(model1));
		PromotionPO model2 = new PromotionPO("00001","代码节促销活动", PromotionType.Discount);
		model2.setDatePromotion(new Date(2016-1900,9,24), new Date(2016-1900,9,26), 0.7, 0, 0);
...
//		PromotionPO model3 = new PromotionPO("00002","会员等级折扣", PromotionType.Discount);
//		model3.setSaleType(SaleType.Rank);
//		model3.setDiscount(0.85);
//		System.out.println(driver.testAddPromotion(model3));
//		PromotionPO model4 = new PromotionPO("00003","来自java的生日问候", PromotionType.Discount);
//		model4.setSaleType(SaleType.Birthday);
//		model4.setDiscount(0.75);
//		System.out.println(driver.testAddPromotion(model4));
//		PromotionPO model5 = new PromotionPO("00004","与Intellij IDEA的合作折扣", PromotionType.Discount);
...
//		System.out.println(driver.testDeletePromotion("00000"));
//		System.out.println(driver.testDeletePromotion("00001"));
//		System.out.println(driver.testDeletePromotion("00002"));
//		System.out.println(driver.testDeletePromotion("00003"));
//		System.out.println(driver.testDeletePromotion("00004"));
//		System.out.println(driver.testDeletePromotion("00005"));
		System.out.println(driver.testGetPromotion("00000"));
