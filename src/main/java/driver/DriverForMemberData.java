...
//		MemberPO member1 = new MemberPO("00000000", "张新悦", "xinxinpassword", "15205153967", 3, 5.0, MemberType.Orinary, getDate("02-11-1997"),"", false);
//		System.out.println(driver.testUpdate(member1));
//		System.out.println(driver.testGetID());
//		MemberPO member2 = new MemberPO(driver.testGetID(), "jingjing", "徐亚婧", "13151530838", 2, 6.0, MemberType.Orinary, getDate("03-03-1997"),"", false);
...
//		System.out.println(driver.testGetID());
//		MemberPO member4 = new MemberPO(driver.testGetID(), "zhuangzhuang", "刚轻厂", "6666666", 1, 8.0, MemberType.Bussiness, null,"新街口", false);
